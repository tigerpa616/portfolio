  ...
  return (
    <div name='home' className='w- full h-screen bg-black'>
       ...
       <div className=' max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          ...
          <div>
            <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-green-800 hover:border-green-800'><Link  to="work"  smooth={true}  duration={500} >View Work</Link>
